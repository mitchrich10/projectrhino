      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center relative overflow-hidden py-16">
            ...
            <div className="absolute inset-0 z-0 grid grid-cols-4">
              <div className="relative overflow-hidden">
                <img src={activePhoto2} alt="" className="w-full h-full object-cover object-top" />
              </div>
            <div className="relative overflow-hidden">
              <img src={activePhoto1} alt="" className="w-full h-full object-cover" />
            </div>
            <div className="relative overflow-hidden">
              <img src={activePhoto4} alt="" className="w-full h-full object-cover object-bottom" />
            </div>
            <div className="relative overflow-hidden">
              <img src={activePhoto3} alt="" className="w-full h-full object-cover" />
            </div>
        ...
        <div>
          <div className="mb-12 text-center relative overflow-hidden py-16">
            ...
            <div className="absolute inset-0 z-0 grid grid-cols-4">
              <div className="relative overflow-hidden">
                <img src={exitPhoto1} alt="" className="w-full h-full object-cover object-top" />
              </div>
              <div className="relative overflow-hidden">
                <img src={exitPhoto3} alt="" className="w-full h-full object-cover" />
              </div>
              <div className="relative overflow-hidden">
                <img src={exitPhoto2} alt="" className="w-full h-full object-cover" />
              </div>
              <div className="relative overflow-hidden">
                <img src={foundersOntopical} alt="" className="w-full h-full object-cover" />
              </div>
              {/* Gradient overlay for text readability */}
              {/* <div className="absolute inset-0 bg-gradient-to-b from-secondary/20 via-background/10 to-background/40" /> */}
            </div>
