...
const RequestsSection: FC<{ userId: string; userEmail: string; companyName: string }> = ({
  ...
  const handleSubmit = async () => {
    ...
    setSubject(""); setNotes(""); setType("resource");
    setSubmitted(true);
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  type === "resource" ? "e.g. Legal templates for SaaS contracts"
                  : type === "partnership" ? "e.g. Introduction to AWS Activate"
                  : type === "event" ? "e.g. Fundraising workshop for Series A"
