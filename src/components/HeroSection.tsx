...
PRODUCER BUSINESSES<span className="text-primary">Producer</span> Businesses<img src={mapleLeaf} alt="Canadian maple leaf" className="inline-block h-[0.5em] ml-2 align-baseline" />
          ...
          <p className="text-lg md:text-xl text-white/70 font-medium mb-10 max-w-2xl leading-relaxed">You deserve a capital partner who amplifies your success<span className="text-primary font-semibold">amplifies your success</span>.
          </p>
